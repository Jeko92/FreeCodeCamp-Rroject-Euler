  ...
  for (row = 1; row < arr.length; row++) {
    for (column = 0; column < arr.length; column++) {
      ...
      for (i = 1; i <= maxOffset; i++) {
        if (arr[row] && arr[row][column + i]) {
          product = product * arr[row][column + i];
        } else {
          break;
        }
      }
      ...
      product = cell;
      for (i = 1; i <= maxOffset; i++) {
        if (arr[row + i] && arr[row + i][column]) {
          product = product * arr[row + i][column];
        } else {
          break;
        }
      }
      ...
      product = cell;
      for (i = 1; i <= maxOffset; i++) {
        if (arr[row + i] && arr[row + i][column + i]) {
          product = product * arr[row + i][column + i];
        } else {
          break;
        }
      }
